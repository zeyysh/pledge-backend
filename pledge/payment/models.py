...
class Customer(models.Model):
    ...
    type = models.CharField(choices=CUSTOMER_TYPE)
    status = models.CharField(choices=CUSTOMER_STATUS)
...
class Transfer(models.Model):
    ...
    source = models.OneToOneField('Customer', on_delete=models.CASCADE)
    destination = models.OneToOneField('Customer', on_delete=models.CASCADE)
